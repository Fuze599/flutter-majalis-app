...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        '/homepage': (context) => HomePage(MyApp._title, _disconnect, _getUserByNumber, _getUserBySearch, _insertCardLine),
      },
    );
  }
  ...
  Future<Object> _getUserBySearch(String search) async {
    var response = await http.get(
        Uri.parse('https://majalis-back.herokuapp.com/clients/search/' + search),
        headers: {
          "Authorization": _token.replaceAll("\"", "")
        }
    );
